...
public class Update_Delete {
	...
	public static void updateRecord() throws SQLException {
		...
		String updateTableQuery = "UPDATE uts SET nama_mhs = 'feby angelan' WHERE id_mhsiswa = '2'";
		...
		try {
			...
			System.out.println(recordCount + " record telah berhasil diupdate pada tabel mhsiswa!");	
		}
